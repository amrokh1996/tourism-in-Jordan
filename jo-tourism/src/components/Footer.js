    ...
    <div className="col-lg-3 col-md-6 mb-5">
      <a href="" className="navbar-brand">
        <h1 className="text-primary">
          JO<span className="text-white">Tourism</span>
        </h1>
      </a>
      <p>
      The Jo-Tourism website organizes group tours at low prices and better service
      </p>
      <h6
...
>
  <div className="row">
    ...
    <div className="col-lg-6 text-center text-md-right">
      <p className="m-0 text-white-50">
        Designed by <a href="https://github.com/amrokh1996">Amro Alkhazaleh</a>
      </p>
    </div>
  </div>
</div>
